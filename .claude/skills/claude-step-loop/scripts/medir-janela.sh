...
#
# Usado por claude-step-loop e claude-simple-loop. Quem mede, e quando, está na
...
#   PASSO=20 medir-janela.sh "S01-plan-outbound-files-metadata"  # planejador (vida ~60 turns)
#   medir-janela.sh "S01-outbound-files-metadata"               # orquestrador de step
